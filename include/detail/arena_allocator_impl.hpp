...
class arena_allocator_impl : public detail::statistics<detail::arena_allocator_tag, traits::k_compute_stats>
{
...
private:
  ...
  inline static void push_memmove(std::vector<memory_move>& dst, memory_move value);
