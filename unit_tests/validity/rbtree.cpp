...
struct RBTreeNode
{
  int                         value;
  bool                        flag;
  cppalloc::detail::tree_node node;
};
...
class RBTreeAcessor
{
  ...
  static inline cppalloc::detail::tree_node const& links(node_type const& inode)
  {
    return inode.node;
  }
  static inline cppalloc::detail::tree_node& links(node_type& inode)
  {
    return inode.node;
  }
...
{
  cppalloc::detail::rbtree<RBTreeAcessor> myTree;
